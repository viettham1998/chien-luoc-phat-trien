    ...
    <div className="mx-auto mt-10 max-w-md animate-floatIn">
      <div className="card p-8">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br from-brand-400 to-brand-700 text-xl font-black text-white shadow-glow">
            KH
          </div>
          <h1 className="text-xl font-bold text-white">Đăng nhập hệ thống</h1>
          <p className="mt-1 text-sm text-white/45">Báo cáo KPIs Chiến lược phát triển · Trường ĐH KHTN</p>
        </div>
        ...
        <div className="mt-6 rounded-xl border border-white/10 bg-white/[0.02] p-3 text-xs text-white/40">
          <div className="mb-1 font-semibold text-white/60">Tài khoản demo</div>
          <div>Super Admin: <span className="text-white/70">admin / admin123</span></div>
          <div>Editor (Khoa CNTT): <span className="text-white/70">cntt / cntt123</span></div>
          <div>Editor (Phòng KHCN): <span className="text-white/70">khcn / khcn123</span></div>
        </div>
      </div>
    </div>
  );
